...
static void input::shutdown(void)
{
}

#if defined(useAnalogButtons) || defined(useDebugTerminal)
static void input::inject(uint8_t buttonValue)
{
...
#endif // defined(useAnalogButtons) || defined(useDebugTerminal)
